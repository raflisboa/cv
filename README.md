...
This repo contains my personal CV, based an easy-to-customize personal dev portfolio template that was created with Sass and JavaScript by Ryan Fitzgerald.
